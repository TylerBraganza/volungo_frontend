...
<template>
    <v-container>
        <div class="text-center" style="margin-bottom: 20px;">
            <h1 style="font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;">Digital Literacy and Access Projects</h1>
        </div>
        <v-row>
            <template v-for="item in project">
                <v-col md="6" v-if="item.category === 'Digital Literacy and Access'" >
                    <v-card
                    color="white"
                    elevation
