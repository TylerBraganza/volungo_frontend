    ...
    <v-container>
        <v-row v-if="application.length">
            <v-col v-for="item in application" :key="item" cols="12" md="12">
                <v-row>
                    <v-card class="d-flex" style="margin-bottom: 20px; border: 2px solid #007CF0;" width="1500px" height="400px">
                        <v-col md="8">
                        ...
                        <v-col md="4">
                            ...
                            <v-card-subtitle style="font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; font-size: 130%; color: #2BB673;" class="pa-2">by: {{ item.projectItem.organization }}</v-card-subtitle>
